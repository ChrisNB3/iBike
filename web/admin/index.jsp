...
<c:if test="${!empty customerRecord}">
    ...
    <table id="adminTable" class="detailsTable">
        ...
        <tr>
            ...
            <td>${customerRecord.department}</td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <table class="embedded detailsTable">
                   <tr class="tableHeading">
                        ...
                        <td class="rigidWidth2">color</td>
                        <td class="rigidWidth2">size</td>
                        <td class="rigidWidth2">quantity</td>
                        <td class="rigidWidth3">price</td>
                    </tr>

                    <tr><td colspan="5" style="padding: 0 20px"><hr></td></tr>
                    ...
                    <c:forEach var="orderedProduct" items="${orderedProducts}" varStatus="iter">
                        ...
                        <tr>
                            ...
                            <td class="quantityColumn">
                                ${orderedProductColors[iter.index].name}
                            </td>
                            <td class="quantityColumn">
                                ${orderedProductSizes[iter.index].name}
                            </td>
                            <td class="quantityColumn">
                    ...
                    <c:if test="${orderRecord.delivery}">
                        <tr>
                            <td colspan="4" id="deliverySurchargeCellLeft"><strong>surcharge</strong></td>
                    ...
                    <c:if test="${orderRecord.discount.doubleValue() ne 0.0}">
                        <tr>
                            <td colspan="4" id="deliverySurchargeCellLeft"><strong>discount</strong></td>
                    ...
                    <tr>
                        <td colspan="4" id="totalCellLeft"><strong>total amount:</strong></td>
