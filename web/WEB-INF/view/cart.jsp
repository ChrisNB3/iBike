      ...
      <table id="cartTable">
        ...
        <c:forEach var="cartItem" items="${cart.items}" varStatus="iter">
          ...
          <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
            ...
            <td>
                <fmt:message key='${cartItem.orderedProductSize.name}'/>
            </td>
            
            <td>
                <fmt:message key='${cartItem.orderedProductColor.name}'/>
            </td>
            ...
            <td style="width:200px">
                ...
                <form action="<c:url value='updateCart'/>" method="post">
                    ...
                    <input type="hidden"
                           ...
                           value="${cartItem.orderedProductColor.id}">
                    <input type="hidden"
                           name="selectedSizeId"
                           value="${cartItem.orderedProductSize.id}">
                    <input type="text"
                           maxlength="2"
                           size="2"
