...
@NamedQueries({
    ...
    @NamedQuery(name = "OrderedProduct.findByOrderedProductColorId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.orderedProductColorId = :orderedProductColorId"),
    @NamedQuery(name = "OrderedProduct.findByOrderedProductSizeId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.orderedProductSizeId = :orderedProductSizeId")})
public class OrderedProduct implements Serializable {
    ...
    @JoinColumn(name = "ordered_product_color_id", referencedColumnName = "id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private OrderedProductColor orderedProductColor;
    ...
    @JoinColumn(name = "ordered_product_size_id", referencedColumnName = "id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private OrderedProductSize orderedProductSize;
    ...
    public OrderedProduct(int customerOrderId, int productId, short orderedProductColorId, short orderedProductSizeId) {
        this.orderedProductPK = new OrderedProductPK(customerOrderId, productId, orderedProductColorId, orderedProductSizeId);
    }
